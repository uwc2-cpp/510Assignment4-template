// Note: This assignment does not require CppUnitLite tests] Define a simple class with a default constructor, 
// a copy constructor (i.e., a constructor that takes the single parameter: const SimpleClass& src), and destructor. 
